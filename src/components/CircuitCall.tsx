...
interface CircuitCallProps {
  ...
  error: string | null;
  onExecuteCircuit: (
    circuitName: 'incrementBy' | 'incrementWithPrivateWitness' | 'reset',
    inputValue: number
  ) => void;
}
...
export const CircuitCall: React.FC<CircuitCallProps> = ({
  ...
  const tenders = [
    {
      ...
      reservePrice: '$150,000 USD',
      deadline: '23h 45m',
      category: 'Enterprise IT',
      verifiedBids: Number(counterValue),
    },
    {
      id: 'TND-2026-094',
  ...
  const handleWitnessSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (inputValue > 0) {
      onExecuteCircuit('incrementWithPrivateWitness', inputValue);
    }
  };
      ...
      <div className="clay-card p-6 border border-gray-800">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-gray-400">Select an enterprise tender to submit your confidential bid proposal.</p>
          </div>
      ...
      <div className="clay-card p-6 md:p-8 border border-gray-800 space-y-6">
        ...
        <form onSubmit={handleWitnessSubmit} className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="text-xs font-bold text-gray-300 uppercase tracking-wider flex items-center gap-1.5">
                ...
                Confidential Bid Value / Strategic Delta
              </label>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
            ...
            <button
              type="button"
              onClick={() => onExecuteCircuit('reset', 0)}
              disabled={!isConnected || isProving}
